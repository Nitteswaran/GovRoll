                ...
                {plans.map((plan, index) => (
                    <motion.div
                        ...
                        className={cn(
                            ...
                            "flex flex-col",
                            !plan.isPopular && "mt-5",
                            index === 0 // Custom 3D transform logic removed to simplify 2-column layout
                                ? "z-0"
                                : "z-10"
                        )}
                    >
                            ...
                            {plan.action ? (
                                <button
                                    ...
                                    className={cn(
                                        ...
                                        "group relative w-full gap-2 overflow-hidden text-lg font-semibold tracking-tighter cursor-pointer",
